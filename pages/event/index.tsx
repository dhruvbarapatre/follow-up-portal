...
export default function ProgramScheduler() {
  ...
  return (
    <div className="p-5 sm:p-6 space-y-6 animate-fadeIn">
      ...
      {isAdding && (
        <form onSubmit={handleSubmit} className="bg-white dark:bg-zinc-900 border border-neutral-100 dark:border-zinc-800 rounded-2xl p-5 shadow-premium animate-slideUp space-y-4">
          <h2 className="text-sm font-bold text-neutral-800 dark:text-zinc-100 font-display">
          ...
          <div className="space-y-3">
            {/* Title */}
            <div>
              <label className="block text-[10px] font-semibold text-neutral-400 dark:text-zinc-500 uppercase tracking-wider mb-1">
                Event Title
              </label>
              <input
                type="text"
            ...
            <div className="border-t border-neutral-100 dark:border-zinc-800/80 pt-4">
              <div className="flex justify-between items-center mb-2">
                <label className="block text-[10px] font-semibold text-neutral-400 dark:text-zinc-500 uppercase tracking-wider">
              ...
              <div className="relative mb-2">
                <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-neutral-400 dark:text-zinc-550">
                  <Search size={12} />
                </span>
                <input
                  type="text"
          ...
          {/* Action Buttons */}
          <div className="flex gap-2 border-t border-neutral-100 dark:border-zinc-800/80 pt-4 mt-6">
            <button
              type="submit"
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="text-center py-12 bg-white dark:bg-zinc-900 rounded-2xl border border-neutral-100 dark:border-zinc-800/80 shadow-premium">
            ...
            <p className="text-[10px] text-neutral-400 dark:text-zinc-500 mt-1 max-w-[200px] mx-auto leading-relaxed">
              ...
              <div
                ...
                className={`bg-white dark:bg-zinc-900 border rounded-2xl shadow-premium overflow-hidden transition-all duration-200 ${
                  isExpanded 
                    ...
                    : "border-neutral-100 dark:border-zinc-800/80 hover:border-neutral-200 dark:hover:border-zinc-700"
                }`}
              >
                {/* Card Main Bar */}
                <div
                ...
                >
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1.5 text-xs text-neutral-500 dark:text-zinc-400 font-sans">
                      ...
                      <span className="flex items-center gap-1">
                        <Clock size={13} className="text-neutral-400 dark:text-zinc-500" />
                        {formatTime12h(program.time)}
                      </span>
                      <span className="flex items-center gap-1">
                        <Users size={13} className="text-neutral-400 dark:text-zinc-500" />
                      ...
                      const renderInviteTable = (invitesList: any[], label: string, isMyList: boolean) => (
                        <div className="space-y-2">
                          ...
                          {invitesList.length === 0 ? (
                            <p className="text-[10px] text-neutral-400 dark:text-zinc-550 italic py-2 pl-1">
